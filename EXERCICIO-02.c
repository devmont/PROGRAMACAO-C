...
// Definindo que aqui começam as variáveis
int main() {
    // Variáveis
    ...
    // Estrutura de repetição para coleta de dados até que a idade 999 seja informada
    do {
        ...
        if (idade != 999) {
            ...
            // Contabilizando as respostas de satisfação específicas
